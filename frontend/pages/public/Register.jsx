// File: frontend/pages/public/Register.jsx
// Global Entry Hub – Register Page (JWT-based, tier-aware, fully styled)
...
export default function Register() {
  ...
  return (
    <>
      <GlobalMetaHelmet title="Register – Global Entry Hub" />
      {/* <HeaderNav /> */}
      <main className="min-h-screen flex flex-col items-center justify-center px-6 py-12 bg-gray-50">
        <div className="max-w-md w-full bg-white border rounded-lg p-6 shadow-md">
          <h1 className="text-2xl font-semibold text-gray-800 mb-6 text-center">Register New User</h1>
